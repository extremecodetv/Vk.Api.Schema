...
{
    /// <summary>
    /// Интерфейс для представления параметров запроса для messages.getChat <para/>
    /// Документация: <see href="https://vk.com/dev/messages.getChat"/>
    /// </summary>
    public interface IMessageGetChatParameters
    {
        /// <summary>
