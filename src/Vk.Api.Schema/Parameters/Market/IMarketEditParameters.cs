...
{
    /// <summary>
    ///  Интерфейс для представления параметров запроса для market.edit <para/>
    /// Документация: <see href="https://vk.com/dev/market.edit"/>
    /// </summary>
    public interface IMarketEditParameters
    {
        /// <summary>
