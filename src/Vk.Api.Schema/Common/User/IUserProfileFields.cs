...
namespace Vk.Api.Schema.Common.User
{
    ...
    public interface IUserProfileFields
    {
        ...
        /// <summary>
        /// Информация поля профиля "Любимые цитаты", (если доступно)
        /// иначе <see langword="null"/>
        /// </summary>
        string Quotes { get; set; }

        /// <summary>
        /// Информация поля профиля "Любимые телешоу", (если доступно)
        /// иначе <see langword="null"/>
        /// </summary>
        string Tv { get; set; }

        /// <summary>
        /// Информация о карьере пользователя (если доступно),
        /// иначе <see langword="null"/>
        /// </summary>
        ICareer Career { get; set; }

        /// <summary>
        /// Информация о городе указанном в профиле пользователя (если доступно),
        /// иначе <see langword="null"/>
        /// </summary>
        ICity City { get; set; }

        /// <summary>
        /// Информация о высшем учебном заведении пользователя (если доступно),
        /// иначе <see langword="null"/>
        /// </summary>
        IEducation Education { get; set; }

        /// <summary>
        /// Информация о военной службе пользователя, (если доступно)
        /// иначе <see langword="null"/>
        /// </summary>
        IMilitary Military { get; set; }

        /// <summary>
        /// Информация о текущем роде деятельности пользователя, (если доступно)
        /// иначе <see langword="null"/>
        /// </summary>
        IOccupation Occupation { get; set; }

        /// <summary>
        /// Информация поля профиля "Жизненная позиция", (если доступно)
        /// иначе <see langword="null"/>
        /// </summary>
        IPersonal Personal { get; set; }

        /// <summary>
        /// Коллекция школ, в которых учился пользователь, (если доступно)
        /// иначе <see langword="null"/>
        /// </summary>
        IEnumerable<ISchool> Schools { get; set; }

        /// <summary>
        /// Коллекция родственников текущего пользователя, (если доступно)
        /// иначе <see langword="null"/>
        /// </summary>
        ...
        /// <summary>
        /// Коллекция ВУЗов в которых учисля пользователь, (если доступно)
        /// иначе <see langword="null"/>
        /// </summary>
