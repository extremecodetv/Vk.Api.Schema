...
namespace Vk.Api.Schema.Tests
{
    ...
    public class GroupTests
    {
        ...
        public void TestGroupBaseInfo()
        {
            ...
            var result = JsonConvert.DeserializeObject<Group>(json);
